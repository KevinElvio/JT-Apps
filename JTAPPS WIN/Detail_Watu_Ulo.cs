...
namespace wisata2
{
    public partial class Detail_Watu_Ulo : Form
    {
        public Detail_Watu_Ulo()
        {
            InitializeComponent();
            getWeather();
            ...
            cmd.CommandText = "select deskripsi_wisata from wisata where id_wisata = 'A02'";
            ...
            comma.CommandText = "select alamat_wisata from wisata where id_wisata = 'A02'";
            ...
            comd.CommandText = "select nama_tiket, harga_tiket from tiket where tiket_id = '3'";
